<?php
/*
Plugin Name: Meherab Feed Importer
Plugin URI: https://example.com/
Description: Custom RSS feed importer plugin built by Meherab Hasan. Lightweight, fast, and easy to use.
Version: 1.0
Author: Meherab Hasan
Author URI: https://example.com/meherab
License: GPLv2 or later
Text Domain: meherab-feed-importer
*/
